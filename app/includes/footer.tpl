  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--cent">
      ...
      <a href="/">
        ...
        <p>
           See <a href="https://github.com/trinityfx/trinity-wallet-web">https://github.com/trinityfx/trinity-wallet-web for complete licensing information.</a>
        </p>
      </a>
    ...
    <section class="footer--righ">
      <p>
        ...
        <a aria-label="github" title="github" href="https://github.com/trinityfx/trinity-wallet-web" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
