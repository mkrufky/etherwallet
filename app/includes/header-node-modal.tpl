  ...
  <section class="modal-dialog">
    <section class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="small"><a href="https://docs.akroma.io/web-wallet/custom-nodes" target="_blank" rel="noopener noreferrer"> Instructions can be found here </a></p>
        ...
        <section class="row">
          ...
          <div class="clearfix col-sm-6 col-sm-offset-6" ng-show="customNode.eip155">
            ...
            <input class="form-control" type="text" placeholder="200625" ng-model="customNode.chainId" ng-class="Validator.isPositiveNumber(customNode.chainId) ? 'is-valid' : 'is-invalid'" value="200625">
          </div>
        </section>
