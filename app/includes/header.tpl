...
<meta name="description" content="MyEgemWallet is a free, open-source, client-side interface for generating Ethereum wallets &amp; interacting with the blockchain easily &amp; securely. Double-check the URL ( MyEgemWallet.com ) before unlocking your wallet.">
<link rel="canonical" href="https://myegemwallet.com" />
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" href="css/etherwallet-master.min.css">
<script type="text/javascript" src="js/etherwallet-static.min.js"></script>
<script type="text/javascript" src="js/etherwallet-master.js"></script>
<link rel="apple-touch-icon" href="images/fav/favicon.ico">
<link rel="icon" href="images/fav/favicon.ico">
<link rel="icon" href="images/fav/favicon.ico">
<link rel="manifest" href="images/fav/manifest.json">
<link rel="mask-icon" href="images/fav/favicon.ico">
<link rel="shortcut icon" href="images/fav/favicon.ico">
<meta name="apple-mobile-web-app-title" content="MyEgemWallet &middot; Your Key to Ethergem">
<meta name="application-name" content="MyEgemWallet">
<meta name="msapplication-config" content="images/fav/browserconfig.xml">
<meta name="theme-color" content="#396a28">
<meta name="google-site-verification" content="IpChQ00NYUQuNs_7Xs6xlnSdzalOlTUYbBsr8f7OpvM" />
<meta property="og:url" content="https://myegemwallet.com" />
<meta property="og:title" content="MyEgemWallet  &middot; Your Key to Ethergem" />
<meta property="og:image" content="/images/myegemwallet-logo-banner.png" />
<meta property="og:image" content="/images/myegemwallet-logo.png" />
<meta property="og:image" content="/images/myegemwallet-logo-square.png" />
<meta property="og:image" content="/images/myegemwallet-banner-fun.jpg" />
<meta property="og:description" content="MyEgemWallet is a free, open-source, client-side interface for generating Ethergem wallets &amp; interacting with the blockchain easily &amp; securely. Double-check the URL ( myegemwallet.com ) before unlocking your wallet." />
...
@@if (site === 'mew' ) {
  <div class="small announcement annoucement-danger">
    <div class="container">
      ...
      <br />
      Make sure you're accessing the EGEM wallet from <strong>https://myegemwallet.com</strong>
    </div>
  </div>
}
  @@if (site === 'cx' ) {
...
<nav role="navigation" aria-label="main navigation" class="container nav-container overflowing" >
  ...
  <div class="nav-scroll">
    <ul class="nav-inner">
      ...
      <li class="nav-item help"><a href="https://myetherwallet.github.io/knowledge-base/" target="_blank" rel="noopener">Help</a></li>
    </ul>
  </div>
