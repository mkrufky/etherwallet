...
NAV_SendEther               : 'Wyślij Akroma i Tokeny ',
...
ERROR_28                    : '**Potrzebujesz plik Keystore i hasło, lub Klucz Prywatny** aby uzyskać dostęp do tego portfela w przyszłości. Wykonaj zewnętrzną kopię bezpieczeństwa! Nie ma możliwości odzyskania portfela jeżeli go nie zapiszesz. Wejdź na [stronę pomocy](https://wallet.akroma.io/#help) po instrukcje. ',
...
HELP_4_Title                : '4) Jak wysłać Akroma z jednego portfela na inny? ',
...
HELP_4_Desc_2               : 'Przejdź na zakładkę "Wyślij Akroma". ',
...
HELP_4CX_Title              : '4)Jak wysłać Akroma używając MyEtherWallet CX? ',
HELP_4CX_Desc_1             : 'Najpierw musisz dodać portfel. Po dodaniu portfela masz 2 możliwości do wyboru: funkcja "Wyślij" z ikony Rozszerzenia Chrome lub zakładka "Wyślij Akroma" ze strony "Moje Portfele". ',
...
HELP_4CX_Desc_12            : 'Używając zakładki "Wyślij Akroma" ',
...
HELP_7_Desc_1               : 'Przejdź na zakładkę "Wyślij Akroma i Tokeny". ',
...
HELP_9_Title                : '9) Czy zakładka "Wyślij Akroma" działa offline? ',
...
HELP_13_Desc_1              : 'Oznacza to, że nie posiadasz wystarczającej ilości Akroma na koncie, aby pokryć koszty paliwa. Każda transakcja (przesyłanie tokenów lub interakcja z kontraktem) wymaga paliwa, które jest opłacane w Akroma\'ach. Wyświetlona wartość jest ilością potrzebną na pokrycie kosztów transakcji w Wei\'ach. Podziel tą liczbę przez `1000000000000000000` i odejmij wartość Akroma, którą chciałeś wysłać (jeśli wysyłałeś Akroma). Otrzymasz wartość, jaką musisz przesłać na swoje konto, aby wykonać transakcję.',
...
HELP_Sec_Desc_4             : 'Sprawdź adres URL -- Ta strona jest serwowana przez GitHub. Kod źródłowy jest dostępny pod: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Strona jest dostępna pod domenami: [https://wallet.akroma.io](https://wallet.akroma.io). ',
