...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `GAS limite` * le `prix du GAS`. [Vous pouvez convertir GWEI -> ETH ici.](https://w.akroma.io/helpers.html)',
...
NAV_SendEther               : 'Envoyer des Akroma et des Tokens ',
...
/* General */
x_Access                    : 'Accès ',
x_AddessDesc                : 'Aussi appelée `adresse` ou `clé publique`. C\'est ce que vous donnez aux gens pour qu\'ils puissent vous envoyer des Akroma ou des Tokens. Remarquez l\'icône colorée. Cette icône doit être identique quand vous entrez votre adresse quelque part.', //Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere. Cette icône est une façon simple de reconnaître votre adresse.
x_Address                   : 'Votre adresse ',
x_Cancel                    : 'Annuler ',
x_CSV                       : 'Fichier CSV (non-chiffré) ',
x_Download                  : 'Télécharger ',
x_Json                      : 'Fichier JSON (non-chiffré) ',
x_JsonDesc                  : 'C\'est la version non-chiffrée au format JSON de votre clé privée. Cela signifie que vous n\'avez pas besoin de votre mot de passe pour l\'utiliser mais que toute personne qui trouve ce JSON peut accéder à votre portefeuille et vos Akroma sans mot de passe. ',
...
MEW_Tagline                 : 'Portefeuille d\'Akroma Open Source, écrit en JavaScript',
CX_Tagline                  : 'Extension Chrome de portefeuille d\'Akroma Open Source JavaScript',
...
ADD_Warning_1               : 'Vous pouvez ajouter n\'importe quel compte pour l\'afficher dans l\'onglet "portefeuilles" sans uploader une clé privée. Cela ne veut **pas** dire que vous aurez accès à ce portefeuille, ni que vous pouvez transférer des Akroma depuis ce portefeuille. ',
...
SENDModal_Content_4         : 'NOTE : Si vous renontrez une erreur, il est très probable que vous deviez ajouter des Akroma à votre compte pour couvrir les coûts (en GAS) d\'envoi des Tokens. Le GAS est payé en Akroma.',
...
PARITY_InvalidGasLimit      : "(parity-05) Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://myetherwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html). Le Gas fourni dépasse la limite.",
PARITY_LimitReached         : "(parity-06) There are too many transactions in the queue. Your transaction was dropped due to limit. Try increasing the gas price. [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html). Il y a trop de transactions en file d\'attente. Votre transaction a été abandonnée en raison de cette limite. Essayez d\'augmenter les frais.",
PARITY_Old                  : "(parity-07) There is already a transaction with this [nonce](https://myetherwallet.github.io/knowledge-base/transactions/what-is-nonce.html). Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://myetherwallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html). Le nonce de la transaction est trop bas. Essayez d\'incrémenter le nonce.",
...
TranslatorName_1            : '[Simon P](https://w.akroma.io/?gaslimit=21000&to=0x89a18eE46b5aabC62e94b1830881887D04C687f3&value=1.0#send-transaction) ·',
...
HELP_0_Desc_5               : 'Transférez de l\'Akroma vers ce nouveau portefeuille.',
...
HELP_2a_Desc_2              : 'Sauvegardez l\'adresse. Vous pouvez la garder pour vous-même ou la partager avec d\'autres personnes qui, de cette manière, peuvent vous envoyer de l\'Akroma.',
HELP_2a_Desc_3              : 'Sauvegardez votre clef privée en plusieurs exemplaires. Ne la partagez avec personne. Votre clef privée est nécessaire pour accéder à votre Akroma et pour l\'envoyer ! Il existe 3 types de clef privée :',
...
HELP_3_Desc_1               : '**Avant d\'envoyer de l\'Akroma à votre portefeuille**, vous devez vous assurer que vous y avez accès.',
...
HELP_3_Desc_8               : 'Si vous désirez détenir une grande quantité d\'Akroma, nous recommandons de commencer par envoyer une petite somme depuis le nouveau portefeuille avant d\'y déposer une somme importante. Envoyez 0,001 Akroma vers le nouveau portefeuille, accédez-y puis envoyez ces 0,001 Akroma vers une autre adresse, et vérifiez que tout a fonctionné sans encombre.',

HELP_4_Title                : '4) Comment puis-je envoyer de l\'Akroma d\'un portefeuille vers un autre ?',
HELP_4_Desc_1               : 'Si vous désirez transférer une grande quantité d\'Akroma, vous devez d\'abord essayer d\'en envoyer un petit montant vers votre portefeuille pour vous assurer que tout fonctionne comme prévu.',
HELP_4_Desc_2               : 'Naviguez vers la page "Envoyer des Akroma et des Tokens".',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'Akroma avec MyEtherWallet CX ?',
HELP_4CX_Desc_1             : 'D\'abord, vous devez ajouter un portefeuille. Ceci fait, deux possibilités s\'offrent à vous : la fonctionnalité "Envoi rapide" de l\'icône de l\'extension Chrome ou la page "Envoyer des Akroma et des Tokens".',
...
HELP_4CX_Desc_12            : 'Avec la page "Envoyer des Akroma et des Tokens" ',
...
HELP_8_Desc_2               : 'Si MyEtherWallet.com venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Ethereum Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre Akroma depuis MyEtherWallet parce qu\'il ne se trouve pas dans MyEtherWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
...
HELP_9_Title                : '9) La page "Envoyer des Akroma et des Tokens" est-elle hors ligne ? ',
...
HELP_10_Desc_11             : 'Sur votre ordinateur en ligne, collez la transaction signée dans le champ texte et cliquez sur "Envoyez l\'Akroma". Ceci émettra votre transaction. ',
...
HELP_13_Desc_1              : 'Cela signifie que vous n\'avez pas assez d\'Akroma sur votre compte pour couvrir les coûts en Gas. Chaque transaction (y compris pour les tokens et les contrats) demande du Gas, et ce Gas est payé en Akroma. Le nombre affiché est le montant requis pour couvrir le coût de la transaction en Wei. Prenez ce nombre, divisez-le par `10^18` (soit `1000000000000000000`) et soustrayez la somme en Akroma que vous essayiez d\'envoyer (si vous tentiez d\'envoyer de l\'Akroma). Cela vous donnera le montant en Akroma que vous avez besoin d\'ajouter à votre compte pour effectuer cette transaction.',
...
HELP_15_Desc_1              : 'Les comptes n\'apparaissent dans un explorateur de blockchain qu\'après une activité, comme par exemple, un envoi ou une réception d\'Akroma.',
...
HELP_Sec_Desc_4             : 'Vérifiez l\'URL -- Ce site est servi par Github (et vous pouvez en voir le code source ici : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages)) vers [https://w.akroma.io](https://w.akroma.io).',
