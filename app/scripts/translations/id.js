...
GAS_Price_1                     : 'Ridak terlalu cepat',
GAS_Price_2                     : 'Cepat',
...
X_Network                       :  'Network', // alias "node" or "chain" - digunakan di dropdown di header
...
EOS_06                          :  'Buka halaman Send Akroma & Tokens',
...
ONBOARD_welcome_content__7      :  '** Anda ** dan ** hanya Anda yang bertanggung jawab atas keamanan Anda.',
...
ONBOARD_bank_content__4         :  'Bank mengizinkan Anda untuk menulis cek atau memakai kartu debit Anda untuk mengirim uang, melihat saldo Anda secara online, mengganti password Anda, dan mendapatkan kartu debit baru jika Anda hilang.',
...
ONBOARD_blockchain_content__2   :  'Ini mencatat siapa yang mengirimkan berapa banyak koin kepada siapa, dan berapa saldo setiap akunnya?.',
...
ONBOARD_why_content__7          :  '**Anda** dan **hanya Anda** yang bertanggung jawab atas keamanan Anda.',
...
ONBOARD_whymew_content__5       :  'Jika Anda tidak berkenan, Anda bisa menggunakan [Coinbase](https://www.coinbase.com/) atau [Blockchain.info](https://blockchain.info/wallet/#/signup). Mereka memiliki akun yang lebih akrab yang menggunakan username & password yang .',
...
ONBOARD_secure_1_content__3     :  'Selalu periksa URLnya: `https://w.akroma.io`.',
ONBOARD_secure_1_content__4     :  'Pastikan bar URL menunjukkan `MYETHERWALLET LLC [US]` dalam warna hijau.',
...
ONBOARD_secure_2_content__5     :  'Jangan biarkan rasa takut, FUD, atau FOMO mengalahkan akal sehat Anda. Jika ada sesuatu yang sangat mendesak, tanyakan pada diri sendiri "mengapa?". Ini mungkin disengaja untuk menciptakan FOMO atau mencegah Anda melakukan penelitian.',
ONBOARD_secure_3_title__alt     :  'Kita ganyang Phisher',
ONBOARD_secure_3_title          :  'Cara Melindungi Diri dari Kerugian',
ONBOARD_secure_3_content__1     :  'Jika sampai kehilangan, kunci privat atau password Anda akan hilang selamanya. Jagalah jangan hilang.',
...
ONBOARD_secure_3_content__5     :  'Jika Anda memiliki nilai kriptocurrency senilai lebih dari gaji 1 minggu Anda, pakailah dompet hardware. Tidak ada alasan untuk tidak memakainya. Biaya yang dikeluarkan sangat sepadan. Percaya saya.',
...
ONBOARD_final_subtitle          :  'Maaf telah memaksa Anda seperti ini. Lanjut!',
...
TXFEE_Desc                  : 'Biaya TX Fee dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Jumlahnya =  `gas limit` * `gas price`. [Anda dapat mengkonversi GWEI -> ETH](https://w.akroma.io/helpers.html)',
...
NAV_SendEther               : 'Kirim Akroma dan Tokens ',
...
/* General */
x_Access                    : 'Akses ',
x_AddessDesc                : 'Address Anda dikenal juga sebagai `Account #` atau `Public Key` Anda. Address inilah yang diberikan kepada pihak lain agar mereka bisa mengirim Akroma atau Token. Pilihlah icon alamat berwarna untuk memudahkan identifikasi. Pastikan Address ini sama persis dengan yang tertulis di Dompet Kertas Anda maupun saat dipakai untuk keperluan lainnya. ',
x_Address                   : 'Alamat Anda ',
x_Cancel                    : 'Batal ',
x_CSV                       : 'File CSV (tidak ter-enkripsi) ',
x_Download                  : 'Unduh ',
x_Json                      : 'File JSON (tidak ter-enkripsi) ',
x_JsonDesc                  : 'Ini adalah "Private Key" Anda dalam format JSON yang tidak ter-enkripsi. Tidak diperlukan password dan siapapun yang memiliki JSON Anda dapat mengakses dompet dan Akroma Anda tanpa password. ',
...
ADD_Warning_1               : 'Akun untuk "dilihat" dapat ditambahkan tanpa menggunakan private key. Namun berarti tidak ada akses ke dompet tersebut dan transfer Akroma tidak bisa dilakukan. ',
...
SENDModal_Content_4         : 'CATATAN: Jika terjadi Error, kemungkinan Anda harus menambah Akroma ke akun Anda untuk menutup biaya gas dan pengiriman. Gas dibayar dalam Akroma. ',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Memungkinkan Anda untuk mencetak Dompet Kertas dari berbagai format atau versi "private key". Hal ini diperlukan pada saat anda ingin [mengimpor akun Anda ke Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Jika Anda hanya ingin pengecekan saldo, pakailah salah satu layanan blockchain explorer seperti [etherscan.io](https://etherscan.io/). ',
...
ERROR_28                    : '**DIPERLUKAN File Keystore & password** (atau Private Key) untuk mengakses dompet Anda. Simpan dan backup dengan baik file ini! Tidak ada mekanisme untuk me-recover dompet jika file-nya hilang. Baca instruksi lengkapnya [di sini](https://w.akroma.io/#help). ',
...
TranslatorName_1            : '[Yos Ginting](https://w.akroma.io/?gaslimit=21000&to=0x8F646C5c215be6E0163f02Bd2eB97AFC2DF70e5c&value=1.0#send-transaction) ',
...
HELP_Remind_Desc_1          : '** Ethereum, MyEtherWallet.com & MyEtherWallet CX, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan ETH Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas Akroma yang hilang**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet.com & MyEtherWallet CX bukan "dompet web". Anda tidak membuat akun atau memberikan Akroma Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_0_Desc_1               : 'MyEtherWallet memberi Anda kemampuan untuk membuat dompet baru sehingga Anda dapat menyimpan Akroma oleh diri Anda sendiri, bukan di bursa. Proses ini dilakukan sepenuhnya di komputer Anda, bukan di server kami. Oleh karena itu, saat Anda membuat dompet baru, **Anda bertanggung jawab untuk menyimpan cadangan/backup-nya dengan aman**. ',
...
HELP_0_Desc_5               : 'Transfer Akroma ke dompet baru ini. ',
...
HELP_2a_Desc_2              : 'Simpan alamatnya. Anda bisa menyimpannya untuk diri sendiri atau membaginya dengan orang lain. Dengan cara itu, orang lain bisa mentransfer Akroma ke Anda. ',
HELP_2a_Desc_3              : 'Simpan untuk diri sendiri semua versi kunci privat. Jangan berbagi dengan orang lain. Kunci privat tersebut akan Anda diperlukan saat Anda ingin mengakses Akroma Anda untuk mengirimkannya! Ada 3 jenis kunci privat: ',
...
HELP_3_Desc_1               : '**Sebelum Anda mengirim Akroma ke dompet baru Anda**, Anda harus memastikan Anda memiliki akses ke dompet baru tersebut. ',
...
HELP_4_Title                : '4) Bagaimana cara mengirim Akroma dari satu dompet ke dompet lainnya? ',
...
HELP_4_Desc_2               : 'Buka halaman "Kirim Akroma dan Token". ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim Akroma menggunakan MyEtherWallet CX? ',
HELP_4CX_Desc_1             : 'Pertama, Anda perlu menambahkan dompet. Setelah melakukannya, Anda memiliki 2 pilihan: menggunakan "QuickSend" dari ikon Chrome Extension atau menggunakan halaman "Kirim Akroma dan Tokens". ',
...
HELP_4CX_Desc_12            : 'Menggunakan halaman "Kirim Akroma dan Tokens" ',
...
HELP_8_Desc_2               : 'Jika situs MyEtherWallet.com tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Akroma Anda dari MyEtherWallet.com karena Akroma Anda tidak disimpan di MyEtherWallet.com. Akroma Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_9_Title                : '9) Kenapa halaman "Kirim Akroma dan Tokens" seperti offline? ',
...
HELP_13_Desc_1              : 'Ini artinya tidak tersedia cukup Akroma di akun Anda untuk menutupi biaya gas. Setiap transaksi (termasuk token dan transaksi kontrak) memerlukan gas dan gas tersebut dibayarkan menggunakan Akroma. Jumlah yang ditampilkan adalah jumlah yang dibutuhkan untuk menutupi biaya transaksi di Wei. Ambil nomor itu, bagi dengan `1000000000000000000`, dan pakai untuk mengurangi jumlah Akroma yang ingin Anda kirim (jika Anda mencoba mengirim Eter). Ini akan memberi Anda jumlah Akroma yang perlu Anda kirim ke akun tersebut untuk melakukan transaksi. ',
...
HELP_15_Desc_1              : 'Account hanya akan muncul di explorer blockchain begitu akun memiliki aktivitas di dalamnya&mdash;misalnya, setelah Anda memindahkan beberapa Akroma ke sana. ',

HELP_16_Title               : '16) Bagaimana cara memeriksa saldo akun saya? ',
HELP_16_Desc_1              : 'Anda bisa menggunakan eksplorer blockchain seperti [etherscan.io](https://etherscan.io/). Paste alamat Anda ke dalam search bar dan riwayat transaksi Anda akan ditampilkan. Contohnya, [akun donasi kami](https://etherscan.io/address/0x7cb57b5a97eabe94205c07890be4c1ad31e486a8) dilihat di etherscan.io ',
...
HELP_Sec_Desc_4             : 'Periksa URL ini -- Situs ini dijalankan melalui GitHub dan Anda bisa melihat sorce code nya di sini: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) ke [https://w.akroma.io](https://w.akroma.io). ',
