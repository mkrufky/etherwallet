...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to w.akroma.io',
...
ONBOARD_blockchain_content__5   :  'When you see your balance on w.akroma.io or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.',
...
FOOTER_1                        :  'Free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the Ethereum blockchain easily &amp; securely. Double-check the URL ( w.akroma.io ) before unlocking your wallet.',
...
NODE_Warning                    :  'Your node must be HTTPS in order to connect to it via w.akroma.io. You can [download the Akroma Web Wallet repo & run it locally](https://github.com/akroma-project/akroma-wallet-web/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
...
HELP_14_Desc_1                  :  'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, w.akroma.io can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
HELP_14_Title                   :  '14) Some sites randomize (seed) the private key generation via mouse movements. w.akroma.io doesn\'t do this. Is the random number generation for Akroma Web Wallet safe?',
...
HELP_3_Desc_3                   :  'Navigate to the w.akroma.io "View Wallet Info" page.',
...
HELP_5_Desc_1                   :  'You can run w.akroma.io on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page.',
HELP_5_Desc_7                   :  'w.akroma.io is now running entirely on your computer.',
...
HELP_5_Desc_9                   :  'As we are constantly updating w.akroma.io, we recommend you periodically update your saved version of the repo.',
HELP_5_Title                    :  '5) How do I run w.akroma.io offline/locally?',
...
HELP_8_Desc_2                   :  'If w.akroma.io goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Akroma out of Akroma Web Wallet because it\'s not in Akroma Web Wallet. It\'s in whatever wallet your generated via our site.',
...
HELP_Desc                       :  'Do you see something missing? Have another question? [Get in touch with us](mailto:support@w.akroma.io), and we will not only answer your question, we will update this page to be more useful to people in the future!',
HELP_FAQ_Title                  :  'More Helpful Answers to Frequent Questions',
HELP_Remind_Desc_1              :  '**Ethereum, w.akroma.io & Akroma Web Wallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Akroma**.',
HELP_Remind_Desc_2              :  'w.akroma.io & Akroma Web Wallet CX are not "web wallets". You do not create an account or give us your Akroma to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
...
HELP_SecCX_Desc_6               :  'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use w.akroma.io instead of this Chrome Extension.',
